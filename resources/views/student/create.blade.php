...
type="text" id="nim" name="nim" class="form-control @error('nim') is-invalid 
...
type="text" id="nama" name="nama" class="form-control @error('nama') is-invalid 
...
type="email" id="email" name="email" class="form-control @error('email') is
